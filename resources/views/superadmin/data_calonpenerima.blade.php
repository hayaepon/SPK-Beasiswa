    ...
    <div class="bg-white p-6 rounded-lg mb-6">
        ...
        <form action="{{ route('calon-penerima.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="flex flex-col">
                    <label for="pilihan_beasiswa" class="text-sm font-medium text-black-700 text-[16px] mb-2">Select</label>
...
<script>
    ...
    entriesInput.addEventListener("input", function () {  // Menggunakan "input" daripada "change" agar langsung terlihat
        const rows = tableBody.getElementsByTagName("tr");
